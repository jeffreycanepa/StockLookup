...
![StockLookup plot](screenShots/StockLookupPlot.png) <figcaption>StockLookup plot OS X</figcaption>

![StockLookup plot Ubuntu](screenShots/StockLookupPlot_Ubuntu.png) <figcaption>StockLookup plot Ubuntu</figcaption>
